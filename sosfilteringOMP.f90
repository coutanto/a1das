...
!
subroutine sosfilt_D(sos,sig,order,ncof,nt,ns)
   implicit none
...
subroutine sosfiltfilt_D(sos,sig,order,ncof,nt,ns)
   implicit none
   integer,intent(in)         :: order         ! filter order
   integer,intent(in)         :: ncof          ! should be 6
   real(kind=8),intent(in)    :: sos(ncof,order)  ! sos matrix
...
subroutine sosfilt_S(sos,sig,order,ncof,nt,ns)
...
subroutine sosfiltfilt_S(sos,sig,order,ncof,nt,ns)
   implicit none
   integer,intent(in)         :: order         ! filter order
   integer,intent(in)         :: ncof          ! should be 6
   real(kind=8),intent(in)    :: sos(ncof,order)  ! sos matrix
